...
// Если, например, поток А стартует первым и первым успеет выполнить функцию lockSecond,
// а за ним то же самое проделает поток B, то метод main завершиться успешно
//
